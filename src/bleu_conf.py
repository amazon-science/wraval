...
def compute_bleu_with_ci(predictions, references, num_bootstrap_samples=1000, confidence_level=0.95):
    ...
    for _ in range(num_bootstrap_samples):
        ...
        score = bleu.compute(predictions=sampled_predictions, references=sampled_references)["bleu"]
